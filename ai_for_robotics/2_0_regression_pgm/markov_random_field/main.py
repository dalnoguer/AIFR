...
beta = 2  # strength of the second order clique criteria
threshold = 0   # convergence threshold
max_iterations = 15  # maximum number of iterations
temperature_init = 4 # initial temperature
discount = .5  # temperature scheduler's factor
...
temperature_init = 4  # initial temperature
discount = 0.95  # temperature scheduler's factor

number_of_labels = 3  # number of labels in the image
size_ratio = 4  # increases the image by size_ratio, just for displaying

image_segmentation2 = MarkovRandomField.ImageSegmenter(beta, threshold, max_iterations, temperature_init, discount,number_of_labels, size_ratio, features2, image2)
